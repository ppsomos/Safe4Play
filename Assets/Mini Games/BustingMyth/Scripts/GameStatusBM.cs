...
public class GameStatusBM : MonoBehaviour
{
    ...
    public void LoadQuestions()
    {
        ...
        NetworkManagerBM nm = GetNetworkManager();
        // Debug.Log("LoadQuestionsGameStatus");
        nm.SetJsonUrl();
        nm.GetQuizQuestions();
    }
    ...
    private NetworkManagerBM GetNetworkManager()
    {
        ...
        NetworkManagerBM nm = go.GetComponent<NetworkManagerBM>();
        return nm;
    }
    ...
    public QuestionBM[] GetQuestions()
    {
        return questions;
    }
